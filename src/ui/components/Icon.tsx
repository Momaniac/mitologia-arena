...
const ICONS = {
  ...
  'wifi-off': (
    <>
      <path d="M3 9a15 15 0 0 1 5.5-3.3" />
      <path d="M21 9a15 15 0 0 0-8.5-3.9" />
      <path d="M6.5 12.7A10 10 0 0 1 9 11.2" />
      <path d="M17.5 12.7a10 10 0 0 0-3-1.6" />
      <path d="M10 16.2a5 5 0 0 1 4.5.5" />
